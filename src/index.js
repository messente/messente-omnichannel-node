...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Channel', 'model/DeliveryReportResponse', 'model/DeliveryResult', 'model/Err', 'model/ErrorItem', 'model/ErrorResponse', 'model/MessageResult', 'model/OmniMessageCreateSuccessResponse', 'model/Omnimessage', 'model/ResponseErrorCode', 'model/ResponseErrorTitle', 'model/SMS', 'model/Status', 'model/Viber', 'model/WhatsApp', 'model/WhatsAppAudio', 'model/WhatsAppDocument', 'model/WhatsAppImage', 'model/WhatsAppText', 'api/DeliveryReportApi', 'api/OmnimessageApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Channel'), require('./model/DeliveryReportResponse'), require('./model/DeliveryResult'), require('./model/Err'), require('./model/ErrorItem'), require('./model/ErrorResponse'), require('./model/MessageResult'), require('./model/OmniMessageCreateSuccessResponse'), require('./model/Omnimessage'), require('./model/ResponseErrorCode'), require('./model/ResponseErrorTitle'), require('./model/SMS'), require('./model/Status'), require('./model/Viber'), require('./model/WhatsApp'), require('./model/WhatsAppAudio'), require('./model/WhatsAppDocument'), require('./model/WhatsAppImage'), require('./model/WhatsAppText'), require('./api/DeliveryReportApi'), require('./api/OmnimessageApi'));
  }
}(function(ApiClient, Channel, DeliveryReportResponse, DeliveryResult, Err, ErrorItem, ErrorResponse, MessageResult, OmniMessageCreateSuccessResponse, Omnimessage, ResponseErrorCode, ResponseErrorTitle, SMS, Status, Viber, WhatsApp, WhatsAppAudio, WhatsAppDocument, WhatsAppImage, WhatsAppText, DeliveryReportApi, OmnimessageApi) {
  'use strict';

  /**
   * Messentes API which allows sending messages via various channels with fallback options.<br>
