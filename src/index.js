...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/MessageResult', 'model/OmniMessageCreateSuccessResponse', 'model/Omnimessage', 'model/SMS', 'model/ScenarioItem', 'model/Scenarios', 'model/Viber', 'omnichannel_api/OmnimessageApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ErrorResponse'), require('./model/MessageResult'), require('./model/OmniMessageCreateSuccessResponse'), require('./model/Omnimessage'), require('./model/SMS'), require('./model/ScenarioItem'), require('./model/Scenarios'), require('./model/Viber'), require('./omnichannel_api/OmnimessageApi'));
  }
