...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Channel', 'model/Err', 'model/Status'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Channel'), require('./Err'), require('./Status'));
  } else {
    // Browser globals (root is window)
    if (!root.OmnichannelApi) {
      root.OmnichannelApi = {};
    }
    root.OmnichannelApi.DeliveryResult = factory(root.OmnichannelApi.ApiClient, root.OmnichannelApi.Channel, root.OmnichannelApi.Err, root.OmnichannelApi.Status);
  }
}(this, function(ApiClient, Channel, Err, Status) {
  'use strict';
