...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmnichannelApi.OmniMessageCreateSuccessResponse();
  });
  ...
  describe('OmniMessageCreateSuccessResponse', function() {
    it('should create an instance of OmniMessageCreateSuccessResponse', function() {
      ...
      //var instance = new OmnichannelApi.OmniMessageCreateSuccessResponse();
      //expect(instance).to.be.a(OmnichannelApi.OmniMessageCreateSuccessResponse);
    });
